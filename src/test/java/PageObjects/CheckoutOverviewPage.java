...
public class CheckoutOverviewPage {
    ...
    public WebElement getCartQuantity(){
        return driver.findElement(By.className("cart-quantity"));
    }
    ...
    public WebElement getSummaryInfoLabel(){
        return driver.findElement(By.className("summary_info_label"));
    }
    public WebElement getSummaryValueLabel(){
        return driver.findElement(By.className("summary_value_label"));
    }

    public WebElement getSummarySubTotalLabel(){
        return driver.findElement(By.className("summary_subtotal_label"));
    }
    public WebElement getSummaryTaxLabel(){
